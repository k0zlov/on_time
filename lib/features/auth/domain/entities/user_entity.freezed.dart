...
class _$UserEntityImpl extends _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, name: $name, lastName: $lastName, email: $email, isActivated: $isActivated, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, lastName, email, isActivated, createdAt);
